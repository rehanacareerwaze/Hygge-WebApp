...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            ...
            dev: {
                files: [
                    {src: ['config/environments/dev/app.js'], dest: 'app.js'},
                    {
            ...
            staging: {
                files: [
                    {src: ['config/environments/staging/app.js'], dest: 'app.js'},
                    {
            ...
            production: {
                files: [
                    {src: ['config/environments/production/app.js'], dest: 'app.js'},
                    {
    ...
    grunt.registerTask('hygge', 'A sample task holder for Hygge application deployment.', function (arg1) {
    });
